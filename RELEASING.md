...
6.0.0 is pinned to its immutable Action tag object
`3c2ed4972c8c53ae02ab5dd5775beccd6da3eeb8` and paired with binary version
6.0.0; preserve that pairing through the release rehearsal.
The same tag workflow publishes 1.0.0 as a stable GitHub release and selects
`v1`; a 1.2.0-rc.4 release candidate is ineligible for that stable channel,
while a later 1.2.0 tag is eligible. Create a
